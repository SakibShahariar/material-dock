    ...
    _openPopover() {
        ...
        file.enumerate_children_async(
            ...
            (src, res) => {
                ...
                infos.sort((a, b) => {
                    const ma = Number(a.get_attribute_uint64('time::modified'));
                    const mb = Number(b.get_attribute_uint64('time::modified'));
                    return mb - ma;
                });
...
class FileStackItem extends PopupMenu.PopupBaseMenuItem {
    _init(fileInfo, folderPath) {
        ...
        const mtime = Number(fileInfo.get_attribute_uint64('time::modified')) / 1000000;
...
class StacksRow extends St.BoxLayout {
    _init(dock) {
        ...
        this._dock = dock;
        this._tiles = [];
        this.refresh(dock.settings.get_strv('folder-stacks'), dock.settings.get_strv('app-groups'));
    }
